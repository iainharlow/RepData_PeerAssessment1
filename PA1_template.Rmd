...
The interval with the greatest number of daily steps is between `r max_interval_start` and `r max_interval_end`, with a mean step rate of `r max_steprate_nice` steps per minute. 
